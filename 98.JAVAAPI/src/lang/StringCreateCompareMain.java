...
public class StringCreateCompareMain {
	...
	public static void main(String[] args) {
		...
		/***String 객체주소비교**/
		if(name1!=name2) {
			System.out.println(">> name1과 name2의 주소는다르다.");
		}
		if(name2!=name3) {
			System.out.println(">> name1과 name3의 주소는다르다.");
		}
		if(name3==name4) {
			System.out.println(">> name3과 name4의 주소는같다.");
		}
		if(name1=="KIM") {
			System.out.println(">> name1과 \"KIM\"의 주소는같다.");
		}
		...
		if(name1.equals(name2)) {
			System.out.println("name1객체의 멤버필드 문자열과 name2객체의 멤버필드 문자열이 동일하다");
		}
		if(name1.equals(name3)) {
			System.out.println("name1객체의 멤버필드 문자열과 name3객체의 멤버필드 문자열이 동일하다");
		}
		if(name1.equals(name4)) {
			System.out.println("name1객체의 멤버필드 문자열과 name4객체의 멤버필드 문자열이 동일하다");
		}
		System.out.println("KIM".charAt(0));
		if("KIM".equals(name4)) {
			System.out.println("\"KIM\" 객체의 문자열과 name4객체의 문자열이동일하다.");
		}
		if(name1.equals("KIM")) {
			System.out.println("name1 객체의 문자열과 \"KIM\"객체의 문자열이동일하다.");
		}
